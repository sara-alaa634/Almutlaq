...
import OurTeamTable from "../../Components/UsersManagmentComponents/OurTeamComponents/OurTeamTable";
    ...
    <Layout>
      ...
      <div className="container">
        ...
        />
       {
        ...
        <div className="card">
        <OurTeamTable fetchFilteredUsersPage={fetchFilteredUsersPage} fetchFilteredUsers={fetchFilteredUsers} removeUser={removeUser}/>
        </div>
      </div>
    </Layout>
  );
