...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className={`btn toggle-sidebar-btn position-fixed py-1 px-2 d-lg-none ${isRTL ? "rtl" : "ltr"
          }`}
        type="button"
      ...
      <div
        className={`offcanvas l-d-bg box-shadow ${isRTL ? "offcanvas-end" : "offcanvas-start"
          } d-lg-none h-100`}
        data-bs-scroll="true"
      ...
      >
        <div
          className={`offcanvas-header d-flex ${isRTL ? "justify-content-end" : "justify-content-start"
            } `}
        >
          <button
            type="button"
            ...
            <ul className="items-list p-0 m-0 mt-1 mb-1">
              ...
              {(hasPermission(permissionsNames.cases.view) ||
                hasPermission(permissionsNames.cases.create)) && (
                  <li className="list-item mt-1">
                    <a
                      className={`list-item-link text-capitalize py-2 px-3 d-flex align-items-center justify-content-between ${isAnyCaseManagementLinkActive ? "active" : ""
                        }`}
                      data-bs-toggle="collapse"
              ...
              {(hasPermission(permissionsNames.posts.view) ||
                hasPermission(permissionsNames.posts.create)) && (
                  <li className="list-item  mt-1 " style={{ display: "none" }}>
                    <a
                      className={`list-item-link text-capitalize py-2 px-3 d-flex align-items-center justify-content-between ${isAnyPostsManagemenTLinkActive ? "active" : ""
                        }`}
                      data-bs-toggle="collapse"
            ...
            <ul className="items-list p-0 m-0 mt-1">
              ...
              {(hasPermission(permissionsNames.office.view) ||
                hasPermission(permissionsNames.office.create)) && (
                  <li className="list-item">
                    <a
                      className={`list-item-link text-capitalize py-2 px-3 d-flex align-items-center justify-content-between ${isAnyOfficeInformationLinkActive ? "active" : ""
                        }`}
                      data-bs-toggle="collapse"
